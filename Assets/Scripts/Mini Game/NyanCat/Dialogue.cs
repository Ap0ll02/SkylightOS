...
using Febucci.UI.Core; // For core typewriter functionality
//using static NyanCatMove;
...
public class Dialogue : MonoBehaviour
{
    ...
    private NyanCatMove nyan;
    public TypewriterByCharacter typewriter; 
    public string[] dialogueLines = new string[5];
    //public animationCo
    //NyanceNyanceSingleton
    // Start is called before the first frame update
    void Start()
    {
        if (NyanceNyanceSingleton == null)
        {
            NyanceNyanceSingleton = GameObject.Find("NyanBossTask");
        }
    ...
    IEnumerator playDialogue()
    {
        ...
        //var animationNyan = nyanCat.GetComponent<Animator>();
        //animationNyan.SetBool("isFlying",true);
        //nyan.isFlying = true;
        NyanceNyanceSingleton.SetActive(true);
        TurnOff();
    }
