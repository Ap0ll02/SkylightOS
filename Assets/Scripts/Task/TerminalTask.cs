...
public class TerminalTask : AbstractTask
{
    ...
    public override void startTask()
    {
        ...
        string termText =
            "Welcome To The Console, Let's get you started downloading some software\n"
    ...
    public void GameEnd()
    {
        if (termState == State.ArrowGameOn)
        {
            ...
            terminalText.text =
                "Download Complete. Please Locate The Installer In The Filesystem.\n";
