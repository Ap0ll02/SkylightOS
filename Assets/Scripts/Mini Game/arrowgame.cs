...
public class Arrowgame : AbstractMinigame
{
    ...
    /// and components.
    [SerializeField]
    GameObject arrow; // Hard reference in Unity, is OKAY because arrow is PreFab'd
    ...
    public void Awake()
    {
        ...
        spawnArea = FindObjectOfType<Terminal>()
            ...
            static Direction P(int dir) =>
                dir switch
                {
                    ...
                    _ => throw new ArgumentException(
                        "Invalid Random Number Cannot Match Enum",
                        nameof(dir)
                    ),
                };
    ...
    {
        TerminalTask.OnArrowPress += HandleInput;
    }
    ...
    public void HandleInput(InputAction.CallbackContext context)
    {
        ...
        else
        {
            ...
            if (
                context.action.ReadValue<float>() == 5
            ...
            // Up Arrow
            if (
                context.action.ReadValue<float>() == 1
                && context.phase == InputActionPhase.Performed
            )
            {
                Debug.Log("Up Arrow");
